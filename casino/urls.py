...
urlpatterns = [
    ...
    path("admin-panel/promote/<int:player_id>/", views.promote_to_admin, name="promote_to_admin"),
    path("admin-panel/delete/<int:player_id>/", views.delete_player, name="delete_player"),
